...
implements Runnable {
    ...
    protected void loadJarURLs() throws Exception {
        ...
        URL path = new URL("https://raw.githubusercontent.com/GalaxyCat10/GLauncher/main/api/");
        int i = 0;
        while (i < jarCount - 1) {
        ...
        try {
            try {
                ...
                if (this.latestVersion != null) {
                    ...
                    if (dir.exists() && this.latestVersion.equals(this.readVersionFile(dir))) {
                        cacheAvailable = true;
                        this.percentage = 90;
                    }
                    if (!cacheAvailable) {
                        ...
                        if (this.latestVersion != null) {
                            this.percentage = 90;
                            this.writeVersionFile(dir, this.latestVersion);
                        }
                    }
                }
